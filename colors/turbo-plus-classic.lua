...
-- Set vim.g.turbo_plus_classic_use_original_blue = true to use the original saturated blue background
local use_original_blue = vim.g.turbo_plus_classic_use_original_blue or false

local p = {
	-- Classic Turbo C++ backgrounds (authentic saturated blue)
	bg = use_original_blue and "#0000A8" or "#000020", -- original blue: #0000A8, softer: #000020
	bg_alt = use_original_blue and "#0000CC" or "#000030",
	bg_menu = use_original_blue and "#0000D0" or "#000040",
	bg_line = use_original_blue and "#0000BE" or "#001050",
	bg_widget = use_original_blue and "#0000BA" or "#001040",
	bg_select = use_original_blue and "#0000DC" or "#002080",
	bg_match = use_original_blue and "#0000DC90" or "#00208090",
	border = "#0000AA",
	border_alt = "#0000CC",
